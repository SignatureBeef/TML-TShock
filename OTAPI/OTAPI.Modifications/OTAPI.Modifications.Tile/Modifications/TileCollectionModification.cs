...
namespace OTAPI.Modification.Tile.Modifications
{
	public class TileCollectionModification : ModificationBase
	{
		...
		public override void Run()
		{
			...
			var _tiles = this.SourceDefinition.Type("Terraria.GameContent.Liquid.LiquidRenderer").Fields
				.SingleOrDefault(x => x.Name == "_tiles");
			if (_tiles != null)
			{
				_tiles.FieldType = iTileCollection;
			}
